...
public record GameStartedEvent(GameId GameId, RoundId RoundId, IEnumerable<RoundPlayer> TeamPlayers, IEnumerable<PlayerDeal> Deals, IEnumerable<Bid> Bids) : GameEventBase(GameId);
