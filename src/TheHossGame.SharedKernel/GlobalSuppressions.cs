...
[assembly: SuppressMessage("Naming", "CA1716:Identifiers should not match keywords", Justification = "Necessary to comply with the naming standard of event sourcing.", Scope = "member", Target = "~M:TheHossGame.SharedKernel.EntityBase`1.When(TheHossGame.SharedKernel.DomainEventBase)")]
